...
#Listing out the movies and their attributes in order:
# Title, Description, Poster Image, Youtube Trailer Link
...
#Creating a list for the fresh_tomatoes.py to pull from
movies = [toy_story, avatar, oceans_11, helvetica, hot_fuzz, dark_knight]

#calling fresh_tomatoes to open up the file
fresh_tomatoes.open_movies_page(movies)

#Extra Potpourri / Testing
